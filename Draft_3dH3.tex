...
\begin{equation}
	...
	\end{aligned}
\end{equation}
We can also provide an expression for $H_{(3)}$, and we will do so here in the simplified case where $\Omega=\tilde\Omega=0$. It is convenient to first define some forms:
\begin{equation}
  \begin{aligned}
