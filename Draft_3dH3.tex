...
Using Hopf coordinates for both $S^3$'s we can write the 5-parameter deformation involving $(\chi_i, \ts{\chi}_i, \psi)$, $i = 1,2$, as follows:
\begin{equation}
	\begin{split}
