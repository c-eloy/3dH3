...
\end{equation}
Under this identification, the shifts \eqref{eq:ShiftSymmetries} correspond to $T$-transformations of the tori, which belong to the modular group $\SL{2,\mathbb{Z}}$, just as for AdS$_4 \times S^5 \times S^1$ \cite{Giambrone:2021zvp,Giambrone:2021wsm}. \CE{(Need to change here given $4\pi$ in \eqref{eq:ShiftSymmetries}?)}
