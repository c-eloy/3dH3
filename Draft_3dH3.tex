...
\subsection{Adding fluxes to other dyonic truncations}
One could also imagine applying the same procedure we described here to turn on fluxes in other maximally supersymmetric compactifications. Natural candidates are the $S^1$ reductions of the consistent truncations to dyonically gauged 4-dimensional maximal supergravities \cite{Guarino:2015jca,Inverso:2016eet}. The 4-dimensional truncations arise from compactifications of 10-dimensional supergravity on $S^6$, $S^5\times S^1$, $S^4\times S^2$, with the 10-d theory corresponding to (massive) IIA/IIB when the spheres have even/odd dimensions, respectively. The corresponding twist matrices for $S^6$, $S^5\times S^1$, $S^4\times S^2$ belong to $\SL{7}$, $\SL{6}\times \SL{2}$ and $\SL{5}\times \SL{3}$, as reviewed in \ref{s:SLn}.

In order to use our procedure for turning on a flux we would have to find singlets in the $\mbf{133}$ of $\En{7}$ under $\SL{7}$, $\SL{6}\times \SL{2}$ and $\SL{5}\times \SL{3}$ for the respective cases. However, it is straightforward to check that there are no singlets corresponding to a $(p-1)$-form potential in the adjoint of $\En{7}$ under these groups. This also stresses why the $S^3\times S^3$ case is special: the $\mbf{133}$ contains a 4 form of $\SL{8}$, which naturally contains the relevant singlets under $\SL{4}\times \SL{4}$. \EM{Needs some thinking -- EM}
