...
\begin{equation}
	\begin{aligned}
		...
		& \times \exp\bigg[\Omega\left(\big(t_{(\mathbf{63},\mathbf{1})}\big)_{1}{}^{1}-\big(t_{(\mathbf{63},\mathbf{1})}\big)_{2}{}^{2}-\big(t_{(\mathbf{63},\mathbf{1})}\big)_{3}{}^{3}+\big(t_{(\mathbf{63},\mathbf{1})}\big)_{8}{}^{8}\right)\\
		&\ \qquad+\ts{\Omega}\left(\big(t_{(\mathbf{63},\mathbf{1})}\big)_{4}{}^{4}-\big(t_{(\mathbf{63},\mathbf{1})}\big)_{5}{}^{5}-\big(t_{(\mathbf{63},\mathbf{1})}\big)_{6}{}^{6}+\big(t_{(\mathbf{63},\mathbf{1})}\big)_{7}{}^{7}\right)\bigg] \\
...
\paragraph{S-fold like deformations (only $(\chi, \ts{\chi})$)}
...
\begin{equation}
	\begin{aligned}
		...
		&\quad +\d\ts{\theta}^{2} + \cos^{2}(\ts{\theta})\,\d\ts{\phi}'_{1}{}^{2} + \sin^{2}(\ts{\theta})\,\d\ts{\phi}'_{2}{}^{2} + \d z^{2}, \\[5pt]
...
\begin{equation}
	\begin{aligned}
		\d\phi'_{1} &= \d\phi_{1} + \chi_{1}\,\d z,\\
		\d\phi'_{2} &= \d\phi_{2} + \chi_{2}\,\d z,\\
		\d\ts{\phi}'_{1} &= \d\ts{\phi}_{1} + \ts{\chi}_{1}\,\d z,\\
